...
const localTranslations: Record<string, string> = {
  ...
  'Add a new admin to your store. They\'ll receive an email invitation.': 'إضافة مشرف جديد إلى متجرك. سيتلقون دعوة عبر البريد الإلكتروني.',
  'John Doe': 'محمد أحمد',
  'john@example.com': 'mohammed@example.com',
  'Role': 'الدور',
